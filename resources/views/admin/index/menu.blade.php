...
<!-- Mirrored from condorthemes.com/cleanzone/dashboard2.html by HTTrack Website Copier/3.x [XR&CO'2013], Mon, 31 Mar 2014 14:32:52 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="/static/js/jquery.vectormaps/jquery-jvectormap-1.2.2.css" type="text/css" media="screen"/>
	<link rel="stylesheet" type="text/css" href="/static/js/jquery.magnific-popup/dist/magnific-popup.css" />
  <link rel="stylesheet" type="text/css" href="/static/js/jquery.niftymodals/css/component.css" />
  <link rel="stylesheet" type="text/css" href="/static/js/bootstrap.summernote/dist/summernote.css" />
...
<body>
            ...
            <div class="nano nscroller">
              <div class="content">
                <ul>
                  <li>
                    <a href="#">
                      <img src="/static/images/avatar2.jpg" alt="avatar" /><span class="date pull-right">13 Sept.</span> <span class="name">Daniel</span> I'm following you, and I want your money! 
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img src="/static/images/avatar_50.jpg" alt="avatar" /><span class="date pull-right">20 Oct.</span><span class="name">Adam</span> is now following you 
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img src="/static/images/avatar4_50.jpg" alt="avatar" /><span class="date pull-right">2 Nov.</span><span class="name">Michael</span> is now following you 
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img src="/static/images/avatar3_50.jpg" alt="avatar" /><span class="date pull-right">2 Nov.</span><span class="name">Lucy</span> is now following you 
                    </a>
                  </li>
                </ul>
              </div>
          ...
          <ul class="timeline">
            ...
            <li>
              ...
              <div class="content">
                ...
                <a class="image-zoom" href="/static/images/gallery/img4.jpg"><img src="/static/images/gallery/img4.jpg" class="img-thumbnail" style="height:64px;" /></a>
                <a class="image-zoom" href="/static/images/gallery/img6.jpg"><img src="/static/images/gallery/img6.jpg" class="img-thumbnail" style="height:64px;" /></a>
              </div>
            </li>
            <li>
            ...
            <li><i class="fa fa-globe purple"></i><span class="date">5 Jan</span><div class="content"><p><strong>María</strong> This is a message for you in your birthday.</p></div></li>
              ...
              <div class="list-group tickets">
                 ...
                 <span class="label label-primary pull-right">Normal</span> <img class="avatar" src="/static/images/avatar_50.jpg"/> 
                  <h4 class="name">Jeff Hanneman</h4>
                  <p>My vMaps plugin doesn't work</p> 
                  <span class="date">17 Feb</span>
                </li>
							  <li class="list-group-item" href="#">
                 <span class="label label-danger pull-right">Urgent</span> <img class="avatar" src="/static/images/avatar4_50.jpg"/> 
                  <h4 class="name">Jhon Doe</h4>
                  <p>My vMaps plugin doesn't work</p> 
                  <span class="date">15 Feb</span>
                </li>
							  <li class="list-group-item" href="#">
                 <span class="label label-warning pull-right">Medium</span> <img class="avatar" src="/static/images/avatar1_50.jpg"/> 
  ...
  <script type="text/javascript" src="/static/js/jquery.niftymodals/js/jquery.modalEffects.js"></script>   
    <script type="text/javascript" src="/static/js/bootstrap.summernote/dist/summernote.min.js"></script>

  <script src="/static/js/jquery.vectormaps/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="/static/js/jquery.vectormaps/maps/jquery-jvectormap-us-merc-en.js"></script>
    <script src="/static/js/jquery.vectormaps/maps/jquery-jvectormap-world-mill-en.js"></script>
    <script src="/static/js/jquery.vectormaps/maps/jquery-jvectormap-fr-merc-en.js"></script>
    <script src="/static/js/jquery.vectormaps/maps/jquery-jvectormap-uk-mill-en.js"></script>
    <script src="/static/js/jquery.vectormaps/maps/jquery-jvectormap-us-il-chicago-mill-en.js"></script>
    <script src="/static/js/jquery.vectormaps/maps/jquery-jvectormap-au-mill-en.js"></script>
    <script src="/static/js/jquery.vectormaps/maps/jquery-jvectormap-in-mill-en.js"></script>
    <script src="/static/js/jquery.vectormaps/maps/jquery-jvectormap-map.js"></script>
    <script src="/static/js/jquery.vectormaps/maps/jquery-jvectormap-ca-lcc-en.js"></script>
  ...
  <!-- Bootstrap core JavaScript
    ...
    <script type="text/javascript">
      $(document).ready(function(){
    	...
    	<script type="text/javascript" src="/static/js/jquery.magnific-popup/dist/jquery.magnific-popup.min.js"></script>
...
<!-- Mirrored from condorthemes.com/cleanzone/dashboard2.html by HTTrack Website Copier/3.x [XR&CO'2013], Mon, 31 Mar 2014 14:34:47 GMT -->
</html>
