...
<html>
	...
	<body>
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
				  <li class="layui-nav-item layui-nav-itemed">
				    ...
				    <dl class="layui-nav-child">
				      <dd><a href="javascript:;" data-url="admin/index/menu" data-id='1' data-text="后台菜单"><span class="l-line"></span>后台菜单</a></dd>
			...
			<div class="main-layout-container">
				...
				<div class="main-layout-header">
					...
					<ul class="layui-nav" lay-filter="rightNav">
					  ...
					  <li class="layui-nav-item">
					    <a href="javascript:;" data-url="admin-info.html" data-id='5' data-text="个人信息">小朱</a>
					  </li>
		...
		<script src="/static/admin/js/module/formate.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>
