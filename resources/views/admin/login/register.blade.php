                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="number" parsley-trigger="change" parsley-error-container="#email-error" required placeholder="手机号码" class="form-control">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="ID" parsley-trigger="change" parsley-error-container="#email-error" required placeholder="身份证号码" class="form-control">
                                </div>
                                <div id="email-error"></div>
                            </div>
                        </div>
